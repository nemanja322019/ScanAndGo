...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20240315154419_AddedWorkingInStoreToUserEntity")]
    partial class AddedWorkingInStoreToUserEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModelsLibrary.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 883, DateTimeKind.Local).AddTicks(9923),
                        ...
                        {
                            Id = 2,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 883, DateTimeKind.Local).AddTicks(9991),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 3,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 883, DateTimeKind.Local).AddTicks(9996),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 4,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(2),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 5,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(9),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 6,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(13),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 7,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(19),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 8,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(24),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 9,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(28),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 10,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(32),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 11,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(38),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 12,
                            PaymentDate = new DateTime(2024, 4, 26, 8, 44, 18, 884, DateTimeKind.Local).AddTicks(42),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
