...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20240315095107_AddedStoreOwner")]
    partial class AddedStoreOwner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModelsLibrary.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(5930),
                        ...
                        {
                            Id = 2,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(5988),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 3,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(5991),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 4,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(5994),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 5,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(5998),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 6,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6001),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 7,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6004),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 8,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6008),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 9,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6052),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 10,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6056),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 11,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6059),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
                        ...
                        {
                            Id = 12,
                            PaymentDate = new DateTime(2024, 4, 26, 2, 51, 6, 703, DateTimeKind.Local).AddTicks(6062),
                            PaymentIntentId = "TestPaymentIntentId",
                            PaymentStatus = 0,
